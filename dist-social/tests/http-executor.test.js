    ...
    },
    {
        ...
        fn: () => {
            ...
            if (prevBase === undefined)
                delete process.env.SOCIAL_META_RETRY_BASE_MS;
            else
                process.env.SOCIAL_META_RETRY_BASE_MS = prevBase;
            if (prevMax === undefined)
                delete process.env.SOCIAL_META_RETRY_MAX_MS;
            else
                process.env.SOCIAL_META_RETRY_MAX_MS = prevMax;
