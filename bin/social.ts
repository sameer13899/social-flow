...
const uninstallCommands = loadCommandModule('uninstall');
...
program.on('--help', () => {
  ...
  console.log(`  ${cmd('uninstall')}               ` + chalk.gray('# Uninstall the global CLI package'));
  ...
  console.log(`  ${cmd('studio')}                  ` + chalk.gray('# Open the Studio app route (browser)'));
