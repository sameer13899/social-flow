...
function getRuntimeRows() {
  return [
    ...
    `${mint('social studio')}  ${chalk.gray('# open bundled Studio app route')}`,
    `${mint('social studio --no-open')}  ${chalk.gray('# print bundled app + context URLs without opening browser')}`,
